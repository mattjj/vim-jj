...
command! -bang -bar -range=0 -nargs=* -complete=customlist,jj#Complete JJ
      \ exe jj#Command(<bang>0, <q-mods>, <q-args>, <line1>, <line2>, <count>)
...
if exists(':J') != 2
  command! -bang -bar -range=0 -nargs=* -complete=customlist,jj#Complete J
        \ exe jj#Command(<bang>0, <q-mods>, <q-args>, <line1>, <line2>, <count>)
endif
